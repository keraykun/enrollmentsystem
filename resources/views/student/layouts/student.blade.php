            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <div class="display:flex; flex-direction:column; align-items:center;">
                        ...
                        <p style="color:green; text-align:center;">{{ Str::ucfirst(Auth::user()->role) }}</p>
                    </div>
                    <ul class="nav" id="side-menu">
                        {{-- <li >
                            <a class="{{ Route::is('student.dashboard.*')?'active':''}}" href="{{ route('student.dashboard.index') }}"><i class="fa fa-dashboard fa-fw "></i> Dashboard</a>
                        </li> --}}
                        <li >
                            <a class="{{ Route::is('student.schedule.*')?'active':''}}" href="{{ route('student.schedule.index') }}"><i class="fa fa-clock-o fa-fw "></i> Schedule</a>
                        </li>
                        <li>
                            <a class="{{ Route::is('student.setting.*')?'active':''}}" href="{{ route('student.setting.index') }}" ><i class="fa fa-cog fa-fw"></i>  Setting </a>
                        </li>
                        <li>
                            <a class="" href="{{ route('guest.logout') }}" ><i class="fa fa-power-off fa-fw"></i>  Sign Out </a>
                        </li>
                         {{-- <li >
                            <a class="{{ Route::is('student.grade.*')?'active':''}}" href="{{ route('student.grade.index') }}"><i class="fa fa-bar-chart fa-fw "></i> Grade</a>
                        </li>
                       <li>
                        ...
                        <li>
                         ...
                         <li>
                            <a class="{{ Route::is('admin.yearlevel.*')?'active':''}} "  href="{{ route('admin.yearlevel.index') }}" ><i class="fa  fa-graduation-cap fa-fw"></i>  Year/Level </a>
                        </li>
                        <li>
