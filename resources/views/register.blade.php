...
<div class="container-fluid" style="">
    <form method="POST" enctype="multipart/form-data" action="{{ route('guest.create') }}">
        @csrf
        <div class="row" style="display: flex;justify-content:center; margin-top: 30px; background: cornflowerblue !important;">
            <div class="col-lg-8" >
               <div class="panel" style="background: white; padding:10px 20px;">
                        ...
                        <div class="row" >
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select onclick="transfereeSelect(event)" class="form-control" name="student_transferee">
                                        <option disabled selected>Choose</option>
                            ...
                            <div class="col-md-6" style="margin: 10px 0px;">
                                <div style="display: inline;" id="transfereeSelect" class="form-group" style="position: relative;">
                                    <label for="filePDF" id="labelPDF" style="font-weight: 600;">Upload Transferee File <br> ( Should PDF File Format )</label>
                                    <input accept="application/pdf" type="file" class="form-control" name="file" id="filePDF">
                                    <div>
                                        <input type="checkbox">
                                        <label for=""><u><i>I Agree to Upload / Follow up my Transferee Data Soon.</i></u></label>
                                    </div>
                                </div>
                                <input required type="checkbox" >
                                <label for=""><u><i>I Agree to Register this School</i></u></label>
                            </div>
                            <div class="col-md-10">
                                <button type="submit" class="btn btn-success">Register Account<i class="fa fa-check"></i></button>
                            </div>
                          </div>
                        </form>
                    </div>
...
<script>
function transfereeSelect(event){
   if(event.target.value==='transferee'){
    document.getElementById('transfereeSelect').style.display='inline'
   }else{
    document.getElementById('transfereeSelect').style.display='none'
   }
}
</script>
@endsection
