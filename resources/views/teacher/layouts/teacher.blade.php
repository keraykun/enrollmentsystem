            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <ul class="nav" id="side-menu">
                        {{-- <li >
                            <a class="{{ Route::is('teacher.dashboard.*')?'active':''}}" href="{{ route('teacher.dashboard.index') }}"><i class="fa fa-dashboard fa-fw "></i> Dashboard</a>
                        </li> --}}
                        <li >
                            <a class="{{ Route::is('teacher.schedule.*')?'active':''}}" href="{{ route('teacher.schedule.index') }}"><i class="fa fa-clock-o fa-fw "></i> Schedule</a>
                        </li>
                        <li >
                            <a class="{{ Route::is('teacher.grade.*')?'active':''}}" href="{{ route('teacher.grade.index') }}"><i class="fa fa-bar-chart fa-fw "></i> Grade</a>
                        </li>
                        <li>
                            <a class="{{ Route::is('teacher.setting.*')?'active':''}}" href="{{ route('teacher.setting.index') }}" ><i class="fa fa-cog fa-fw"></i>  Setting </a>
                        </li>
                        <li>
