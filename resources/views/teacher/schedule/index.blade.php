                    ...
                    <div class="card-header">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">
                                <span style="font-weight: bold; letter-spacing:1px; margin-right:10px; display: flex; justify-content:space-between"><a href="{{ route('teacher.schedule.show',$schedule->id) }}" class="btn btn-info">View Room</a>
                                   <a href="{{ route('teacher.schedule.ended',$schedule->id) }}" class="btn btn-warning">End Room</a></span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="card ended-subject" style="box-shadow: rgb(205, 90, 94) 0px 3px 8px; padding:10px; opacity:0.6;">
                    <div class="card-header">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item" style="display: flex; justify-content:space-between"><span style="font-weight: bold; letter-spacing:1px; margin-right:10px;"><a href="{{ route('teacher.schedule.show',$schedule->id) }}" class="btn btn-info">View Room</a></li>
                        </ul>
                    </div>
                </div>
            </div>
