                    ...
                    <div class="card-header">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">
                                <span style="font-weight: bold; letter-spacing:1px; margin-right:10px; display: flex; justify-content:space-between"><a href="{{ route('teacher.grade.show',$schedule->id) }}" class="btn btn-info">View Grade</a>
                ...
                <div class="card ended-subject" style="box-shadow: rgb(205, 90, 94) 0px 3px 8px; padding:10px; opacity:0.6;">
                    <div class="card-header">
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item" style="display: flex; justify-content:space-between"><span style="font-weight: bold; letter-spacing:1px; margin-right:10px;"><a href="{{ route('teacher.grade.show',$schedule->id) }}" class="btn btn-info">View Grade</a></li>
                        </ul>
                    </div>
                </div>
            </div>
