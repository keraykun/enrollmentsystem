...
<div class="row">
    ...
    <div class="col-lg-6" >
            ...
            <div class="col-md-12">
                <a href="{{ route('admin.student.gradeprint',['student'=>$student->id,'department'=>$student->academic->department->id,'year'=>$student->academic->year->id]) }}" class="btn btn-info"><i class="fa fa-print">Print Grade</i></a>
            </div>
