...
<div class="row">
    ...
    <div class="row" style="margin-top: 30px;">
            <div class="col-md-12">
                <a href="{{ route('admin.student.subjectprint',['student'=>$student->id,'department'=>$student->academic->department->id,'year'=>$student->academic->year->id]) }}" class="btn btn-info"><i class="fa fa-print">Print Subject</i></a>
            </div>
                    ...
                    <div class="card" style="box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px; padding:10px;">
                        <div class="card-header">
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item"><span style="font-weight: bold; letter-spacing:1px; margin-right:10px;">Schedule : </span><span>@if($schedule->teacher_schedule->schedule!=null){{ $schedule->teacher_schedule->schedule->day }} - {{ date('h:i a',strtotime($schedule->teacher_schedule->schedule->start_time)).' ~ '.date('h:i a',strtotime($schedule->teacher_schedule->schedule->end_time)) }} @endif</span></li>
